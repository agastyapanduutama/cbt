...
$sql = mysqli_query($sqlconn, "DELETE FROM cbt_peserta WHERE id_peserta = '$_REQUEST[id_peserta]'");
}
            ...
            <div class="row">
				...
				<?php } ?>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th width="10%">NRP Peserta</th>
                                        <th width="20%">Nama Peserta</th>
                                        <th width="12%">Hapus</th>                                    
                                        </tr>
                                </thead>
                                <tbody>
                <?php   $sql = mysqli_query($sqlconn, "select * from cbt_peserta order by id_peserta");
                        while($s = mysqli_fetch_array($sql)){
                ?>
                            <tr class="odd gradeX">
                                <td align="center"><?php echo $s['nrp_peserta']; ?></td>
                                <td align="center"><?php echo $s['nama_peserta']; ?></td>
                                <td align="center"><?php echo "<a href='#myModal' id='custId' data-toggle='modal' data-id=".$s['id_peserta'].">"; ?>
                                    <a href="?modul=daftar_siswa&aksi=hapus&id_peserta=<?php echo $s['id_peserta']; ?>">
                                    <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o "></i></button></a>
                                </td>
