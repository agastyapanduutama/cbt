...
$hehe1 = "select * from cbt_soal where XKodeSoal = '$var_soal' and XJenisSoal = '1'";

$sqlsoal = mysqli_num_rows(mysqli_query($sqlconn, $hehe1)); 
...
$sqlsiswa = mysqli_query($sqlconn, "SELECT * FROM `cbt_peserta` WHERE nrp_peserta= '$var_siswa' ");
$s = mysqli_fetch_array($sqlsiswa);
$namsis = $s['nama_peserta'];
$kokel = $s['kode_kelas'];
$nomsis = $s['nrp_peserta'];
$namjur = $s['kode_kelas'];
$fotsis = "";
    ...
    <div class="left">
             <div class="panel panel-default">
              ...
              <td rowspan="5" width="150px"><img src="../../fotosiswa/<?php echo $foto; ?>" width="60%" /></td></td>
                <td width="30%">NRP Peserta </td><td width="40%">: <?php echo "$var_siswa [$var_token]"; ?></td>
                
              </tr>
                                                <!-- <tr><td>Nomer Induk Siswa(NIS)</td><td>: <?php echo $nomsis; ?></td></tr> -->
                                                <tr><td>Nama Peserta </td><td>: <?php echo $namsis; ?></td></tr>
...
<input type="number" max="100" min="0" id="jawab<?php echo "$nosoal"; ?>" name="jawab<?php echo "$nosoal"; ?>" class="masuk<?php echo "$nosoal"; ?>" 
style="height:50px; width:85px; font-size:36px; padding-left:5px;color:#32689a" value="<?php echo "$nil"; ?>"/>
