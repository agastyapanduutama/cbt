            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example"  >
                                ...
                                <tbody>
                                <?php 
                                $baba = "select * from cbt_siswa_ujian c left join cbt_peserta s on s.nrp_peserta = c.XNomerUjian  
                                    left join cbt_ujian u on u.XTokenUjian = c.XTokenUjian  where c.XKodeSoal = '$_REQUEST[soal]'";
								$sql = mysqli_query($sqlconn, $baba);
								// echo "$baba";
								$so = 1;
					...
					$sqlpakai = mysqli_num_rows(mysqli_query($sqlconn, "select * from cbt_nilai where XKodeSoal = '$s[XKodeSoal]'"));
					   ...
					   $hehe2 = "select sum(XNilaiEsai) as hasil from cbt_jawaban where XKodeSoal = '$s[XKodeSoal]' and XUserJawab = 
                        '$s[nrp_peserta]' and XTokenUjian = '$s[XTokenUjian]'";
						$sqljumlahx = mysqli_query($sqlconn, $hehe2);
                        // echo "$hehe2";
						$o = mysqli_fetch_array($sqljumlahx);
						$cekjum = mysqli_num_rows($sqljumlahx);
						$nilaiawal = round($o['hasil'],2);
						$sqljur = mysqli_query($sqlconn, "SELECT * FROM `cbt_peserta` WHERE nama_peserta= '$s[nama_peserta]' ");
						...
						$kojur = $sjur['XKodeJurusan'];
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <?php echo $so; ?></td>
                                        <td><?php echo $s['nrp_peserta']; ?></td>
                                        <td align="center"><?php echo $s['XKodeUjian']; ?></td>
                                        <td><?php echo $s['nama_peserta']; ?></td>                                      
                                        ...
                                        <td align="center"><a href=?modul=lks&soal=<?php echo $s['XKodeSoal']; ?>&siswa=<?php echo $s['nrp_peserta']; ?>&token=<?php echo $s['XTokenUjian']; ?>>
