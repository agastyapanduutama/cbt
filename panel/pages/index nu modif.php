...
<header>
	<nav class="navbar navbar-default" >
			<div class="navbar-header" style="width:100%;  background-color:<?php echo $skul_warna; ?>; >
				<a class="navbar-header" ><img style="width:100px" alt="Brand" src="../../images/<?php echo $skul_ban; ?>"></a>
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; 
	border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center"><span style="color: #ff0000;"><?php echo strtoupper($skull); ?> </span>| <span style="color: #1B06CF;">suported by DIANGLOBAL-TECH</span>
</div>
