...
<div style="width: 80%; float:right">
   ...
   <br>Hal ini berakibat beberapa soal menjadi kosong / tidak tampil di lembar ujian CBT.<p>
                        ...
                        <button style="display: none;" type="button" class="btn btn-success btn-small"><i class="fa fa-cloud-download"></i> Template Soal Peminatan</button></a>
                        <a href="../../file-excel/bee_soal_agama.xls" target="_blank">
                        <button style="display: none;" type="button" class="btn btn-success btn-small"><i class="fa fa-cloud-download"></i> Template Soal Agama</button></a>
