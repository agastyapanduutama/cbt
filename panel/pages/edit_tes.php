...
<div id="infoz" class="infoz"></div>
	<table width="100%" border="0" >
		<tr hidden=""><td>Jenis Ujian <td>: &nbsp; &nbsp;<td>
			<select class="form-control" hi id="txt_ujian<?php echo $s['Urutan']; ?>">
        ...
        <?php	echo "<option value='1'>TOKEN Ditampilkan </option>";
		...
		<tr hidden=""><td>Soal PDF  <font color="#cd0202"><b>*</b></font><td>: <td>                                 
			<select class="form-control" class="form-control" id="txt_pdf<?php echo $s['Urutan']; ?>">
				<?php 	echo "<option value='0'>Bukan PDF</option>";
				 ...
				 ?>
		<td hidden="">Nama File PDF <font color="#cd0202"><b>*</b></font><td>: <td> 
		...
		<td><td><td hidden=""><font color="#cd0202">Contoh penulisan : soal1.pdf</font></td>
		</tr>
