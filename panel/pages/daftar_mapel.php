...
<div class="modal fade" id="myTam" role="dialog">
        ...
        <form action="?modul=daftar_mapel&tambah=yes" method="post">
            ...
            <div class="form-group">
                ...
                <select style="display: none;" id="txt_mapelagama"  name="txt_mapelagama" class="form-control" >
				<option value='N' selected="" class='form-control' >MAPEL UMUM</option>
...
<hr />
            <div class="form-group">
				...
				<tr>
                <td>
                <input type="text" style="display: none;" value="50" class="form-control" name="txt_UH">                
                <input type="text" style="display: none;" value="50" class="form-control" name="txt_UTS">                
                </td>
                <td>
                <input type="text" style="display: none;" value="50" class="form-control" name="txt_UAS">                
                </td><td>&nbsp;</td><td>
