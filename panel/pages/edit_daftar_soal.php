...
?>
    ...
    <?php echo "
    <a href=?modul=daftar_soal><button type='button' class='btn btn-default'><i class='fa fa-arrow-circle-left'></i> Kembali ke Bank Soal</button></a> 
    ...
    <a href=?modul=tambah_musik&jum=1&pil=$_REQUEST[jum]&tambahan=ok&soal=$_REQUEST[soal]><button type='button' class='btn btn-primary'><i class='fa fa-music'></i> Tambah Suara</button></a>
    "; ?>
