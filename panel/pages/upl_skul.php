...
<div class="group">
    ...
    <div class="right">
    			<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%">
                            <tr height="42px"><td>Kode</td><td>: <td><input class="form-control" type="text" id="txt_kode" value="<?php echo "$skulkode"; ?>"/></td></tr>
                            <tr height="42px"><td>Nama</td><td>: <td><input class="form-control" type="text" id="namaskul" value="<?php echo "$skulnam"; ?>"/></td></tr>
                            <tr style="display: none;" height="42px"><td>Level Sekolah</td><td>: <td>
							...
							<tr style="display: none;" height="42px"><td>Login Header 2</td><td>: <td><input class="form-control" type="text" id="txt_h2"  value="<?php echo "$h2"; ?>"/></td></tr>
