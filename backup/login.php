...
if ($val == TRUE) {
	...
	$logo = "logo.gif";
	$warna = "#0AF713";
	if (file_exists('./config/madipo_cbt.sql')) {
		$footer = "MADIPO-CBT";
	} else {
		$footer = "DIANGLOBAL-TECH";
	}
}
?>
<!DOCTYPE html>
...
<body class="font-medium">
	...
	<header style="background-color:<?php echo "$warna"; ?>">
		<div class="group">
			<div class="left" style="background-color:<?php echo "$warna"; ?>"><img style="width: 100px" src="images/<?php echo $banner; ?>" style=" margin-left:0px;"></div>
			<div class="right">
				<table width="100%" border="0" style="margin-top:10px">
					<tr>
						<td rowspan="3" width="120px" align="center"><img src="images/avatar.gif" style=" margin-left:0px;" class="foto"></td>
						<td>Selamat Datang Peserta Ujian</td>
					</tr>
					<tr>
						<td><span class="user">Jangan Lupa Berdo'a </span></td>
					</tr>
					<tr>
						<td><span class="log"><a href="index.php">Logout</a><span></td>
					</tr>
				</table>
			</div>
	...
	<ul>
		...
		<div id="myerror" class="alert alert-danger" role="alert" style=" font-size: 13px; font-style:normal; font-weight:normal; margin-left:-40px; padding-left:30px;">
			...
			if (isset($_REQUEST['salah'])) {
				if ($_REQUEST['salah'] == 2) {
					echo "<b><li>Database belum tersedia, Hubungi Administrator Ujian </li></b>";
				} elseif ($_REQUEST['salah'] == 1) {
					echo "<b><li>Username atau Password anda salah</li></b>";
				} elseif ($_REQUEST['salah'] == 3) {
					echo "<b><li>Anda Sudah Login di tempat lain atau NRP sudah ada yang menggunakan silakan periksa kembali NRP anda</li></b>";
				}
				$_REQUEST['salah'] = "";
			}
			?>
	...
	<div class="col-md-4 col-md-offset-4 login-wrapper" id="panel_login" style="float:inherit; margin-top:0px;  max-width:500px;">
		<div class="panel panel-default" style="margin-top:20px">
			...
			<div class="inner-content" style="height:250px">
				<form action="masuk_peserta.php" method="post" data-toggle="validator" id="form1"><input type="hidden">
					<div class="form-horizontal" style="margin-top:0px"><br>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="UserName">NRP Peserta</label>
							<div class="col-sm-8 input-wrapper">

								<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
								<input class="form-control" autocomplete="off" style="width:84%; height:37px; margin-left:38px;" data-val="true" data-val-required="User name wajib diisi" id="inputUsername" name="nrp_peserta" placeholder="NRP Peserta" type="number" required value="">
							</div>
						</div>
						<!--
				<div class="form-group">
				...
				-->
						<div class="form-group">
							...
							<label class="col-sm-3 control-label" for="Password">Nama Peserta</label>
							<div class="col-sm-8 input-wrapper">

								<span class="glyphicon glyphicon-user" aria-hidden="true"></span>
								<input class="form-control" autocomplete="off" style="width:84%; height:37px; margin-left:38px" data-val="true" data-val-required="Nama Peserta wajib diisi" id="password" name="nama_peserta" placeholder="Nama Peserta" type="text" required value="">
								<br>
							</div>
						</div>
	...
	<div id="buntut">
		...
		<div style="margin-top:0px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
			<div class="content">
				<?php if (file_exists('./config/madipo_cbt.sql')) {
					echo "MADIPO-CBT :";
				} else {
					echo "DIANGLOBAL-TECH";
				} ?>
				<!-- <strong> v3_Rev3</strong><br>
				Modified @2017 by MBA -->
				<!--		DIANGLOBAL-TECH : <strong> v3.0</strong><br>
		...
		<footer>
			<div class="group" style="background-color:<?php echo $warna; ?>;">
				<div style="background-color:<?php echo $warna; ?>; padding:7px; font-size:12px">
					<p><b><span style="color: #ff0000;"><?php echo strtoupper("$footer"); ?> </span></b><br> <span style="color: #1B06CF;">Supported by DIANGLOBAL-TECH</span></p>
				</div>
		</footer>
