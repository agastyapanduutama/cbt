...
for ($i=3; $i<=$baris; $i++)
{
 ...
 // if tanya = kosong 
  if(!str_replace(" ","",$xkat)==""){ 
            ...
            XJawab4,XGambarJawab4, XJawab5,XGambarJawab5, XAudioTanya, XVideoTanya, XGambarTanya, XKunciJawaban,XJenisSoal,XKategori,XAcakSoal,XAcakOpsi,XAgama,XDeskripsi,XBab) 
            ...
            '$xjwban','$xjen','$xkat','$xacak','$xacakopsi','$xagama','$xdeskripsi','$xbab')";
