...
$status_konek = "1";
mysql_select_db($database, $link) or die('<b><span style="color: #ff0000;">SERVER tidak terhubung ke DataBase SERVER PUSAT</span><br><br>SOLUSI : <br></br>Edit koneksi database DIANGLOBAL-TECH-CBT dengan tepat</b> >> Langkah :
