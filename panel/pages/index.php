...
header("Location: logout.php");
	...
	elseif($_REQUEST['modul']=="tambah_musik") {$bread = "<a href=?modul=daftar_soal>Bank Soal</a> &#8226; <a href=?modul=edit_soal&jum=$_REQUEST[jum]&soal=$_REQUEST[soal]>Daftar Soal</a>  &#8226; <font color=#F70505>Tambah Musik</font>";}	
...
<!-- //////// ADMIN (1) ////////  -->	
	...
	<div id="page-wrapper"><!-- page wrapper -->
		<?php	if(isset($_REQUEST['modul'])==""){include "none.php";}	
				...
				elseif($_REQUEST['modul']=="tambah_musik"){include "tambah_musik.php";}
				...
				elseif($_REQUEST['modul']=="cetak_hasil"){include "ujianna.php";}	
...
<div class="modal fade" id="myCetakKartu" role="dialog">
	...
	<div class="panel-heading">
		...
		<form action="?modul=cetak_kartu" target="_blank" method="post">
			<div class="panel-body">
			<div class="inner-content">
			<div class="wysiwyg-content">
...
<form action="ujianna.php" target="_blank" method="post">
    <div class="panel-body">
    <div class="inner-content">
    <div class="wysiwyg-content">
        <p><table width="100%">
			<tr style="display: none" height="40px"><td></td><td> &nbsp;&nbsp;<td>                                  
            ...
            <tr style="display: none" height="40px"><td width="30%"></td><td><td>  
			...
			<?php echo $tgl=date('d-m-Y');?>
			<tr height="40px"><td>Tanggal </td><td>:<td>                               
	               <input type="date" class="form-control" value="<?= $tgl?>" required="" name="tanggal">
				</td>
			</tr> 
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; 
	border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center"><span style="color: #ff0000;"><?php echo strtoupper($skull); ?> </span> <span style="color: #1B06CF;"></span>
</div>
