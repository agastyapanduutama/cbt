...
$hit = 1;
  ...
  $sqlambilsoalpilT1 = mysqli_query($sqlconn, "SELECT * FROM cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' OR XAcakSoal = 'T' order by Urut LIMIT  $xjumpilg");
  }  
...
'$xsetidx','$xkodemapel','$xsemester')"); 
  ...
  $sqlambilsoalpilA2 = mysqli_query($sqlconn, "SELECT * FROM cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'Y' order by RAND() LIMIT  $jmlpilA");  
  }
	    ...
	    <li class="header">
           ...
           <span class="flex-putih">SOAL NO. </span>
            <span class="flex-item" style="background-color:<?php echo $cssb; ?>"  id="soal"></span>
                  ...
                  <div id="">
                  <input type="hidden" name="berhenti" id="erenanhela">
                  <div id="audionaplayna" class="jp-jplayer"></div>
                ...
                <?php if ($val_audio != "" ) {?>
                    <!-- <button type="button" id="tombolaudio" onclick="playAudio()">Play</button> -->
                    <!-- <button type="button" id="tombolaudio1" onclick="pauseAudio()" >Pause</button> -->
