...
$_SESSION["nrp_peserta"] = $nrp_peserta;
...
<?php	$sqlcekujian = mysqli_num_rows(mysqli_query($sqlconn, "
	SELECT * FROM cbt_ujian 
	WHERE
	-- (XKodeKelas = '$xkelz' OR XKodeKelas = 'ALL') AND 
	(XKodeJurusan = '$xjurz' OR XKodeJurusan = 'ALL') 
	AND XStatusUjian = '1' 
...
<footer>
    <div  style=" background-color:<?php echo "$r[XWarna]"; ?>; padding:7px; font-size:12px"">
        <p><b><span style="color: #ff0000;"><?php echo strtoupper("$r[XSekolah]"); ?> </b><br> <span style="color: #1B06CF;"></span></p>
    </div>
</footer>
...
<script src="mesin/js/backend.js"></script>
 ...
 <?php
	...
	<div class="list"><br>TOKEN Anda: --[<span style="color: #ff0000;"><b>
	<?php 	if($xstatustoken==1) {
