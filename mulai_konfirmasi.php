...
$xtokenujian = $s['XTokenUjian'];  
	...
	$cekka = "SELECT XTokenUjian FROM cbt_ujian WHERE XTglUjian = '$tglna'";
	$dataToken = mysqli_query($sqlconn, $cekka);
	while ($data = mysqli_fetch_array($dataToken)) {
		$tokenNya[] = $data['XTokenUjian'];
	}
